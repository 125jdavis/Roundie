 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --font src/fonts/Montserrat-SemiBold.ttf --size 96 --bpp 4 --format lvgl --no-compress --lv-include lvgl.h --lv-font-name lv_font_montserrat_semibold_96 --symbols  %°λ=+-.:0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz -o src/fonts/lv_font_montserrat_semibold_96.c
 ******************************************************************************/
...
#ifndef LV_FONT_MONTSERRAT_SEMIBOLD_96
#define LV_FONT_MONTSERRAT_SEMIBOLD_96 1
#endif

#if LV_FONT_MONTSERRAT_SEMIBOLD_96
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x9f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xfb, 0x0, 0x0, 0x0,
    0x5, 0xff, 0xff, 0xff, 0xff, 0xfa, 0x51, 0x0,
    0x14, 0x9e, 0xff, 0xff, 0xff, 0xff, 0x70, 0x0,
    0x0, 0x1e, 0xff, 0xff, 0xff, 0xfb, 0x10, 0x0,
    0x0, 0x0, 0x0, 0x9f, 0xff, 0xff, 0xff, 0xf2,
    0x0, 0x0, 0x8f, 0xff, 0xff, 0xff, 0x70, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x5, 0xff, 0xff, 0xff,
    0xfa, 0x0, 0x0, 0xff, 0xff, 0xff, 0xf8, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x7f, 0xff,
    0xff, 0xff, 0x20, 0x6, 0xff, 0xff, 0xff, 0xc0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc,
    0xff, 0xff, 0xff, 0x80, 0xa, 0xff, 0xff, 0xff,
    0x40, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x3, 0xff, 0xff, 0xff, 0xd0, 0xe, 0xff, 0xff,
    0xfe, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0xdf, 0xff, 0xff, 0xf1, 0x1f, 0xff,
    0xff, 0xf9, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x9f, 0xff, 0xff, 0xf3, 0x3f,
    0xff, 0xff, 0xf7, 0x0, 0x0, 0x0, 0x0, 0x0,
    ...
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x5f, 0xff,
    0xff, 0xf5, 0x2f, 0xff, 0xff, 0xf7, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x7f,
    0xff, 0xff, 0xf4, 0xf, 0xff, 0xff, 0xfb, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0xaf, 0xff, 0xff, 0xf2, 0xd, 0xff, 0xff, 0xff,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0xef, 0xff, 0xff, 0xf0, 0x9, 0xff, 0xff,
    0xff, 0x70, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x6, 0xff, 0xff, 0xff, 0xb0, 0x4, 0xff,
    0xff, 0xff, 0xf1, 0x0, 0x0, 0x0, 0x0, 0x0,
    ...
    0xff, 0xa7, 0x55, 0x7a, 0xef, 0xff, 0xff, 0xff,
    ...
    0xff, 0x20, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x5, 0xff, 0xff, 0xfb, 0x62, 0x0, 0x0, 0x38,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1321, .box_w = 77, .box_h = 69, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 2657, .adv_w = 906, .box_w = 45, .box_h = 44, .ofs_x = 6, .ofs_y = 12},
    {.bitmap_index = 3647, .adv_w = 591, .box_w = 27, .box_h = 11, .ofs_x = 5, .ofs_y = 22},
    {.bitmap_index = 3796, .adv_w = 375, .box_w = 17, .box_h = 17, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 3941, .adv_w = 1034, .box_w = 57, .box_h = 70, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 5936, .adv_w = 585, .box_w = 28, .box_h = 68, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 6888, .adv_w = 894, .box_w = 53, .box_h = 68, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 8690, .adv_w = 894, .box_w = 52, .box_h = 69, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 10484, .adv_w = 1043, .box_w = 62, .box_h = 68, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 12592, .adv_w = 897, .box_w = 53, .box_h = 69, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 14421, .adv_w = 963, .box_w = 54, .box_h = 70, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 16311, .adv_w = 934, .box_w = 53, .box_h = 68, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 18113, .adv_w = 1001, .box_w = 56, .box_h = 70, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 20073, .adv_w = 963, .box_w = 54, .box_h = 70, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 21963, .adv_w = 375, .box_w = 17, .box_h = 53, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 22414, .adv_w = 906, .box_w = 45, .box_h = 33, .ofs_x = 6, .ofs_y = 17},
    {.bitmap_index = 23157, .adv_w = 1150, .box_w = 74, .box_h = 68, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 25673, .adv_w = 1169, .box_w = 60, .box_h = 67, .ofs_x = 9, .ofs_y = 0},
    {.bitmap_index = 27683, .adv_w = 1103, .box_w = 63, .box_h = 70, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 29888, .adv_w = 1269, .box_w = 67, .box_h = 68, .ofs_x = 9, .ofs_y = 0},
    {.bitmap_index = 32166, .adv_w = 1029, .box_w = 51, .box_h = 68, .ofs_x = 9, .ofs_y = 0},
    {.bitmap_index = 33900, .adv_w = 978, .box_w = 50, .box_h = 68, .ofs_x = 9, .ofs_y = 0},
    {.bitmap_index = 35600, .adv_w = 1186, .box_w = 64, .box_h = 70, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 37840, .adv_w = 1244, .box_w = 60, .box_h = 68, .ofs_x = 9, .ofs_y = 0},
    {.bitmap_index = 39880, .adv_w = 490, .box_w = 13, .box_h = 68, .ofs_x = 9, .ofs_y = 0},
    {.bitmap_index = 40322, .adv_w = 809, .box_w = 45, .box_h = 69, .ofs_x = -2, .ofs_y = -1},
    {.bitmap_index = 41875, .adv_w = 1120, .box_w = 62, .box_h = 68, .ofs_x = 9, .ofs_y = 0},
    {.bitmap_index = 43983, .adv_w = 920, .box_w = 48, .box_h = 68, .ofs_x = 9, .ofs_y = 0},
    {.bitmap_index = 45615, .adv_w = 1467, .box_w = 74, .box_h = 68, .ofs_x = 9, .ofs_y = 0},
    {.bitmap_index = 48131, .adv_w = 1244, .box_w = 60, .box_h = 67, .ofs_x = 9, .ofs_y = 0},
    {.bitmap_index = 50141, .adv_w = 1293, .box_w = 73, .box_h = 70, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 52696, .adv_w = 1115, .box_w = 57, .box_h = 68, .ofs_x = 9, .ofs_y = 0},
    {.bitmap_index = 54634, .adv_w = 1293, .box_w = 76, .box_h = 84, .ofs_x = 4, .ofs_y = -15},
    {.bitmap_index = 57826, .adv_w = 1123, .box_w = 58, .box_h = 68, .ofs_x = 9, .ofs_y = 0},
    {.bitmap_index = 59798, .adv_w = 966, .box_w = 55, .box_h = 70, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 61723, .adv_w = 925, .box_w = 58, .box_h = 68, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 63695, .adv_w = 1212, .box_w = 60, .box_h = 69, .ofs_x = 8, .ofs_y = -1},
    {.bitmap_index = 65765, .adv_w = 1120, .box_w = 72, .box_h = 68, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 68213, .adv_w = 1757, .box_w = 106, .box_h = 68, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 71817, .adv_w = 1064, .box_w = 66, .box_h = 68, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 74061, .adv_w = 1015, .box_w = 66, .box_h = 68, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 76305, .adv_w = 1018, .box_w = 59, .box_h = 68, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 78311, .adv_w = 932, .box_w = 47, .box_h = 53, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 79557, .adv_w = 1054, .box_w = 56, .box_h = 73, .ofs_x = 7, .ofs_y = -1},
    {.bitmap_index = 81601, .adv_w = 892, .box_w = 51, .box_h = 53, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 82953, .adv_w = 1055, .box_w = 55, .box_h = 73, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 84961, .adv_w = 955, .box_w = 54, .box_h = 53, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 86392, .adv_w = 567, .box_w = 38, .box_h = 72, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 87760, .adv_w = 1066, .box_w = 56, .box_h = 72, .ofs_x = 3, .ofs_y = -20},
    {.bitmap_index = 89776, .adv_w = 1052, .box_w = 52, .box_h = 72, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 91648, .adv_w = 444, .box_w = 16, .box_h = 75, .ofs_x = 6, .ofs_y = 0},
    {.bitmap_index = 92248, .adv_w = 453, .box_w = 32, .box_h = 94, .ofs_x = -9, .ofs_y = -20},
    {.bitmap_index = 93752, .adv_w = 975, .box_w = 55, .box_h = 72, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 95732, .adv_w = 444, .box_w = 13, .box_h = 72, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 96200, .adv_w = 1617, .box_w = 87, .box_h = 52, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 98462, .adv_w = 1052, .box_w = 52, .box_h = 52, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 99814, .adv_w = 991, .box_w = 56, .box_h = 53, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 101298, .adv_w = 1054, .box_w = 56, .box_h = 71, .ofs_x = 7, .ofs_y = -19},
    {.bitmap_index = 103286, .adv_w = 1054, .box_w = 55, .box_h = 71, .ofs_x = 3, .ofs_y = -19},
    {.bitmap_index = 105239, .adv_w = 645, .box_w = 31, .box_h = 52, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 106045, .adv_w = 791, .box_w = 45, .box_h = 53, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 107238, .adv_w = 651, .box_w = 38, .box_h = 64, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 108454, .adv_w = 1046, .box_w = 51, .box_h = 52, .ofs_x = 7, .ofs_y = -1},
    {.bitmap_index = 109780, .adv_w = 888, .box_w = 57, .box_h = 51, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 111234, .adv_w = 1412, .box_w = 88, .box_h = 51, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 113478, .adv_w = 880, .box_w = 55, .box_h = 51, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 114881, .adv_w = 888, .box_w = 58, .box_h = 71, .ofs_x = -2, .ofs_y = -20},
    {.bitmap_index = 116940, .adv_w = 817, .box_w = 45, .box_h = 51, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 118088, .adv_w = 644, .box_w = 34, .box_h = 33, .ofs_x = 3, .ofs_y = 36},
    {.bitmap_index = 118649, .adv_w = 888, .box_w = 59, .box_h = 72, .ofs_x = -3, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_montserrat_semibold_96 = {
#else
lv_font_t lv_font_montserrat_semibold_96 = {
#endif
...
#endif /*#if LV_FONT_MONTSERRAT_SEMIBOLD_96*/
