 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --font src/fonts/Montserrat-Medium.ttf --size 72 --bpp 4 --format lvgl --no-compress --symbols 0123456789.- --output src/fonts/lv_font_montserrat_medium_72.c
 ******************************************************************************/

#include "lvgl.h"

#ifndef LV_FONT_MONTSERRAT_MEDIUM_72
#define LV_FONT_MONTSERRAT_MEDIUM_72 1
#endif

#if LV_FONT_MONTSERRAT_MEDIUM_72
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_montserrat_medium_72 = {
#else
lv_font_t lv_font_montserrat_medium_72 = {
#endif
...
#endif /*#if LV_FONT_MONTSERRAT_MEDIUM_72*/
